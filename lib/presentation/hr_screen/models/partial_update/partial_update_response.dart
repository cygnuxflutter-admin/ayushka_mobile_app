...
PartialUpdateResponse partialUpdateResponseFromJson(String str) =>
    PartialUpdateResponse.fromJson(json.decode(str));

String partialUpdateResponseToJson(PartialUpdateResponse data) =>
...
class PartialUpdateResponse {
  ...
  factory PartialUpdateResponse.fromJson(Map<String, dynamic> json) =>
      PartialUpdateResponse(
        status: json["status"],
