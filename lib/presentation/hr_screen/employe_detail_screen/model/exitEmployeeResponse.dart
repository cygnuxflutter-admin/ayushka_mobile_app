...
ExitEmployeeResponse exitEmployeeResponseFromJson(String str) =>
    ExitEmployeeResponse.fromJson(json.decode(str));

String exitEmployeeResponseToJson(ExitEmployeeResponse data) =>
    json.encode(data.toJson());

class ExitEmployeeResponse {
  final String status;
  final String message;
  final Data data;

  ExitEmployeeResponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory ExitEmployeeResponse.fromJson(Map<String, dynamic> json) =>
      ExitEmployeeResponse(
        status: json["status"],
