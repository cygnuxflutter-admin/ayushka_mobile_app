                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: DropdownSearch<EmployeeData>(
                                  ...
                                  items: (filter, loadProps) => controller.employeeList.where((emp) =>
                                  emp.payrollName.toLowerCase().contains(filter.toLowerCase()) ||
                                      emp.empId.toLowerCase().contains(filter.toLowerCase())).toList(),
                                  ...
                                  decoratorProps: DropDownDecoratorProps(
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: const Padding(
                                        ...
                                        child: Image(
                                          image: AssetImage('assets/images/remarkIcon.png'),
                                          height: 30,
                                          width: 30,
                                        ),
                                      ),
                      ...
                      controller.cowType == 'Pregnant'
                          ? Center(
                              child: GestureDetector(
                                onTap: () {
                                  Get.toNamed(AppRoutes.addNewCow, arguments: {
                    ...
                    ? Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Get.toNamed(AppRoutes.CowTransfer, arguments: {
                                  'shedId': controller.shedId.value,
                                  'tagId': controller.cowId.value,
                                  'calfName': controller.cowName.value,
                                });
