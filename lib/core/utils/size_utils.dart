...
Size get size => Size(Get.width, Get.height);
...
double get height {
  ...
  double bottomBar = 0;
  if (Get.context != null) {
    statusBar = MediaQuery.of(Get.context!).padding.top;
    bottomBar = MediaQuery.of(Get.context!).padding.bottom;
  }
  double screenHeight = Get.height - statusBar - bottomBar;
  return screenHeight;
}
